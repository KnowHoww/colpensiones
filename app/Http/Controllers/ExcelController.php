...
class ExcelController extends Controller
{
    ...
    private function obtenerTablaDetalleRiesgo() {
        // Simulando la obtención de datos desde la base de datos
        return [
            ['Detalle de Riesgo' => '(Convi.) Fe de Vida Nómina de Pensionados', 'cod' => '100'],
            ['Detalle de Riesgo' => '(Convi.) Radicación después 5 años al fallecimiento causante', 'cod' => '101'],
            ['Detalle de Riesgo' => '(Convi.) Contradicción Extremos Convivencia', 'cod' => '102'],
            ['Detalle de Riesgo' => '(Convi.) Otras contradicciones  (Ej. Apellido de casado diferente, o estado civil, PQRS)', 'cod' => '103'],
            ['Detalle de Riesgo' => '(Convi.) Sociedad Conyugal Vigente', 'cod' => '104'],
            ['Detalle de Riesgo' => '(Convi.) Anotación Marginal RCM', 'cod' => '105'],
            ['Detalle de Riesgo' => '(Convi.) Mas de Un Solicitante', 'cod' => '106'],
            ['Detalle de Riesgo' => '(Convi.) Declaraciones o residencia del solicitante en ciudad diferente a la muerte del causante', 'cod' => '107'],
            ['Detalle de Riesgo' => '(DepenEconom.) Solicitante calidad de padres – Hijos pierden derecho – es mayor a 25 años.', 'cod' => '108'],
            ['Detalle de Riesgo' => '(DepenEconom.) Hermanos Inválidos', 'cod' => '109'],
            ['Detalle de Riesgo' => '(DepenEconom.) Hijo invalido sin enfermedades congénitas', 'cod' => '110'],
            ['Detalle de Riesgo' => '(DepenEconom.) (Padres) Recibe ingresos de pensión mayor a dos (2) SMLMV', 'cod' => '111'],
            ['Detalle de Riesgo' => '(DepenEconom.) (Padres) Se encuentra afiliado a salud como cotizante', 'cod' => '112'],
            ['Detalle de Riesgo' => '(ValDocum.) Sentencia Declaración UMH', 'cod' => '113'],
            ['Detalle de Riesgo' => '(ValDocum.) Dictamen JRNCI Aportado Solicitante', 'cod' => '114'],
            ['Detalle de Riesgo' => '(ValDocum.) Dictamen Emitido EPS No Afiliado a Colpensiones', 'cod' => '115'],
            ['Detalle de Riesgo' => '(Escolar) Verificación Escolaridad', 'cod' => '116'],
            ['Detalle de Riesgo' => '(AuxFuner.) Solicitud Posterior Un Año', 'cod' => '117'],
            ['Detalle de Riesgo' => '(AuxFuner.) Mas de un solicitante con mismo servicio - más de una factura', 'cod' => '118'],
            ['Detalle de Riesgo' => '(ConservaDerecho) Nómina de Pensionados', 'cod' => '119'],
            ['Detalle de Riesgo' => '(Convi.) Diferencia edad 20 años sin hijos', 'cod' => '120'],
